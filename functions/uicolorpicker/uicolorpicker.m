...
% Draw Dialog...
hFig = figure('position',[position(1) position(2) 170 180],...
    'Name','Color',...
    'NumberTitle','off',...
    'Menubar','none',...
    'Color',SysCol,...
...
Loaded = load([pathstr '\Palette_test.col'],'-mat');
...
CtrlTags(1,:) = {'FrmCol11','FrmCol21','FrmCol31','FrmCol41'};
CtrlTags(2,:) = {'FrmCol12','FrmCol22','FrmCol32','FrmCol42'};
CtrlTags(3,:) = {'FrmCol13','FrmCol23','FrmCol33','FrmCol43'};
CtrlTags(4,:) = {'FrmCol14','FrmCol24','FrmCol34','FrmCol44'};

for i = 1:4 % For each row in the grid...   
    for ctrl = 1:4 
        CLR = CLR + 1;            
